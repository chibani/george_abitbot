...
ClasseBot.prototype._isEqual = function (message, text) {
    return message.type === 'message' && message.text === text;
};

ClasseBot.prototype._contains = function (message, text) {
    return message.type === 'message' && message.text.toLowerCase().indexOf(text) > -1;
};
